<!---
title: A Confession from Ghost-O-Meter’s Creator
template: post
date: October 11, 2015
mediumUrl: https://medium.com/@ade3/a-confession-from-ghost-o-meter-s-creator-594b50fe4fa7#.jgfoolpo0
description: I released Ghost-O-Meter with a secret. I realize now that it was a mistake.
categories: Design Thinking, Personal Stories, Self Promotion
folder: Writing/2015
layout: 
--->
...
Every year around Halloween hoards of thrill seekers fire up [Ghost-O-Meter](https://itunes.apple.com/us/app/ghost-o-meter/id476468510?mt=8) to see if the needle will wiggle. As the static crackles and the bulb brightens a lucky few make contact with the paranormal. If the app itself doesn’t scare the hell out of you, what I am going to tell you just might.
...
This code hidden in my app is the eyeball of a massive creature. Follow the tendrils of this lens to its source and you will find the largest artificial intelligence man has ever created. _The Central Brain._
...
While Ghost-O-Meter doesn’t access any personal data beyond what I mentioned above, and although I can’t tell who you are, that doesn’t mean you are anonymous to Central Brain. You see, Ghost-O-Meter is not Central Brain’s only way of seeing you. _It has eyes everywhere._
...
As of this writing, an analytics-free version of Ghost-O-Meter is still waiting for approval from Apple but it should be available at any moment. In the meantime, download and use [the current version of Ghost-O-Meter](https://itunes.apple.com/us/app/ghost-o-meter/id476468510?mt=8) at your own risk.
...
*I use the word “observing” figuratively. Don’t misinterpret this to mean that your device’s camera is recoding photos or video of you. I am 90% sure that Central Brain can’t access your camera. _Geez, I hope not._
