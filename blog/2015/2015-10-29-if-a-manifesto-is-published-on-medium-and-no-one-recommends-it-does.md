<!---
title: If a manifesto is published on Medium and no one recommends it, does it make a sound?
template: post
date: October 29, 2015
mediumUrl: https://medium.com/@ade3/if-a-manifesto-is-published-on-medium-and-no-one-recommends-it-does-it-make-a-sound-d8ca1658594c#.n6ilif8pw
mediumStatus: deleted
folder: Writing/2015
description: Anybody can write a manifesto and there is nothing that says it has to inspire anybody. But if you are going to fill space with corporate jargon, what are you hoping to accomplish? Why would you share it with the world if you have nothing new to contribute?
...
I read [a manifesto the other day that left me completely uninspired][1]. It came from a company that seems pretty cool, so I was kind of disappointed. When somebody writes a manifesto I expect them to be trying to start a revolution, not regurgitate corporate platitudes.
...
Actually, years ago I worked on a manifesto so tonight I decided to look it up and see how well it aged. I wrote it [back in 2004 when Be A Design Group was still thriving][2]. Granted, I had pretty good source material, but still. Here’s the back story…

In 1964 a group of designers composed the\_ First Things First\_ manifesto. They were reacting against the ad-saturated environment that they believed damaged the integrity of their craft. You can read it at: [First Things First 1964][3].
...
#### An Alternative to First Things First
...
[1]:	https://medium.com/@dlpasco/the-black-pixel-manifesto-bdca9b3b3a78#.dxt31a9l9
[2]:	https://withinthefold.com/another-design-manifesto/
[3]:	http://maxb.home.xs4all.nl/ftf1964.htm
[4]:	http://www.emigre.com/Editorial.php?sect=1&id=14