<!---
title: Fatal Side Effects of Specialization
template: post
date: April 23, 2016
mediumUrl: https://medium.com/@ade3/fatal-side-effects-of-specialization-b21a9e147ced#.fqlbowoan
folder: Writing/2016
categories: Buckminster Fuller, Career Advice, Design Thinking
description: What is the opposite of specialization? It's not generalization. We don’t need more general knowledge, more generic solutions, or more oatmeal. We need to transcend the silos of specialization. 
layout: 
--->
...
## Avoiding war through polymathization
...
So indulge me as I invent a new word: _polymathization_. That is necessary because I want to play a word game with Bucky’s statement. Let’s rearrange the words and match them with their antonyms. The result looks like this:

_If_  
Specialization = Isolation  
_then_  
Polymathization = Community

_If_  
Specialization = Futility  
_then_  
Polymathization = Capability

_If_  
Specialization = Confusion  
_then_  
Polymathization = Clarity

_If_  
Specialization = Bias  
_then_  
Polymathization = Impartiality

_If_  
Specialization = War  
_then_  
Polymathization = Peace

Does this word game match up to your reality?
...
It is hard enough to stay relevant in a single discipline, the energy required to become a polymath is intimidating. But to be blunt, the world doesn’t need more specialists. Specialists are obsolete and so are the pointless wars we wage inside our companies. Or as Bucky says, “Either war is obsolete, or men are.”

* * *

Thanks for reading. I try to post a story like this each week, so consider following me to keep up with my ramblings. I am so grateful to everyone who shares my stories each week and helps spread my ideas. Thank you.
